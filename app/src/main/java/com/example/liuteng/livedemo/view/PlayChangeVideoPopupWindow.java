...
public class PlayChangeVideoPopupWindow{
	...
	class VideosAdapter extends BaseAdapter {
		...
		@Override
		public int getCount() {
			return RecordRadioFragment.playVideoIds.length;
		}

		@Override
		public Object getItem(int position) {
			
			return RecordRadioFragment.playVideoIds[position];
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.tv.setText(RecordRadioFragment.playVideoIds[position]);
